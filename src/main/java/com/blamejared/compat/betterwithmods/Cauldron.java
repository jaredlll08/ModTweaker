...
public class Cauldron {
    ...
    public static void remove(IItemStack output) {
        ModTweaker.LATE_ADDITIONS.add(new BulkRemove("Set Cauldron Recipe", CauldronManager.getInstance(), InputHelper.toStack(output), ItemStack.EMPTY));
    }

    @ZenMethod
    public static void remove(IItemStack output,@Optional IItemStack secondary, IIngredient[] inputs) {
        ModTweaker.LATE_ADDITIONS.add(new BulkRemove("Remove Cauldron Recipe", CauldronManager.getInstance(), InputHelper.toStack(output),  secondary != null ? InputHelper.toStack(secondary) : ItemStack.EMPTY, InputHelper.toObjects(inputs)));
    }
