        ...
        List<String> args = StringHelper.toLowerCase(Arrays.asList(arguments));
            ...
            if(args.contains("apothecary")) {
                for(RecipePetals recipe : BotaniaAPI.petalRecipes) {
                    ...
                    CraftTweakerAPI.logCommand(String.format("mods.botania.Apothecary.addRecipe(%s, %s);",
                ...
                for(RecipeBrew recipe : BotaniaAPI.brewRecipes) {
                    ...
                    CraftTweakerAPI.logCommand(String.format("mods.botania.Brew.addRecipe(%s, \"%s\");",
                ...
                for(RecipeManaInfusion recipe : BotaniaAPI.manaInfusionRecipes) {
                    ...
                    CraftTweakerAPI.logCommand(String.format("mods.botania.ManaInfusion.add%s(%s, %s, %d);",
                ...
                for(RecipePureDaisy recipe : BotaniaAPI.pureDaisyRecipes) {
                    ...
                    CraftTweakerAPI.logCommand(String.format("mods.botania.PureDaisy.addRecipe(%s, %s);",
                            LogHelper.getStackDescription(recipe.getInput()),
                            //TODO CHECK THIS
                ...
                for(RecipeRuneAltar recipe : BotaniaAPI.runeAltarRecipes) {
                    ...
                    CraftTweakerAPI.logCommand(String.format("mods.botania.RuneAltar.addRecipe(%s, %s, %d);",
                            LogHelper.getStackDescription(recipe.getOutput()),
                            LogHelper.getListDescription(recipe.getInputs()),
                            recipe.getManaUsage()
                            ));
